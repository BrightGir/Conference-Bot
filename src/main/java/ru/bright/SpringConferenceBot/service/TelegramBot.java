package ru.bright.SpringConferenceBot.service;
...
import ru.bright.SpringConferenceBot.config.BotConfig;
import ru.bright.SpringConferenceBot.model.ScienceSeminar;
import ru.bright.SpringConferenceBot.model.User;
import ru.bright.SpringConferenceBot.service.callbacks.*;
import ru.bright.SpringConferenceBot.service.callbacks.page.JoinedSeminarsPageCallbackAction;
import ru.bright.SpringConferenceBot.service.callbacks.page.OwnSeminarAdditionalInfoPageCallbackAction;
import ru.bright.SpringConferenceBot.service.callbacks.page.SeminarsPageByCategoryCallbackAction;
import ru.bright.SpringConferenceBot.service.callbacks.page.SeminarsPageByChatIdCallbackAction;
import ru.bright.SpringConferenceBot.service.commands.*;
import ru.bright.SpringConferenceBot.service.commands.admin.AdminPanelCommand;
import ru.bright.SpringConferenceBot.service.keyboards.reply.AdminKeyboard;
import ru.bright.SpringConferenceBot.service.keyboards.reply.BaseReplyKeyboard;
import ru.bright.SpringConferenceBot.service.keyboards.reply.FunctionalReplyKeyBoard;
...
import ru.bright.SpringConferenceBot.service.requests.WaitingNotifyMessageRequest;
import ru.bright.SpringConferenceBot.service.requests.WaitingSeminarIdToDeleteRequest;
import ru.bright.SpringConferenceBot.service.requests.WaitingSeminarPanelIdRequest;
...
import ru.bright.SpringConferenceBot.service.utils.*;
...
public class TelegramBot extends TelegramLongPollingBot {
    ...
    private void registerCallbackActions() {
        ...
        this.registerCallbackData(CallBackDates.BACK_TO_PANEL.toString(), (BiConsumer<Update, User>) (update, user) ->  {
            ScienceSeminar seminar = this.getSeminarsManager().getSeminarByPrimaryId(Long.parseLong(update.getCallbackQuery().getData().split("_")[3]));
        ...
        this.registerCallbackData(CallBackDates.NOTIFY_PARTICIPANTS.toString(), (BiConsumer<Update, User>) (update, user) -> {
            ...
            this.sendRequest(new WaitingNotifyMessageRequest(this,user,seminarsManager.getSeminarByPrimaryId(id)),5);
        });
        ...
        this.registerCallbackData(CallBackDates.DELETE_SEMINAR_ACCEPT.toString(), (BiConsumer<Update, User>) (upd, user) -> {
            ...
            ScienceSeminar sem = this.getSeminarsManager().getSeminarByPrimaryId(seminarId);
