...
public class InlineSeminarTimeNotifiesKeyboard extends InlineKeyboardMarkup {
    ...
    public void init() {
        ...
        String add = " ✅";
        ScienceSeminar seminar = bot.getSeminarsManager().getSeminarByPrimaryId(seminarId);
        ...
        but1.setText("1 час" + (bot.getSeminarsManager().hasNotify(user,seminar,1) ? add : ""));
        ...
        but2.setText("3 часа"+ (bot.getSeminarsManager().hasNotify(user,seminar,3) ? add : ""));
        ...
        but3.setText("6 часов"+ (bot.getSeminarsManager().hasNotify(user,seminar,6) ? add : ""));
        ...
        but4.setText("12 часов"+ (bot.getSeminarsManager().hasNotify(user,seminar,12) ? add : ""));
        ...
        but5.setText("16 часов" + (bot.getSeminarsManager().hasNotify(user,seminar,16) ? add : ""));
        ...
        but6.setText("24 часа" + (bot.getSeminarsManager().hasNotify(user,seminar,24) ? add : ""));
