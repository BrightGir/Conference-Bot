package ru.bright.SpringConferenceBot.service.keyboards.reply;
...
@Component
public class AdminKeyboard extends ReplyKeyboardMarkup {
    ...
    private void init() {
        ...
        row2.add(getButton(Constants.ADMIN_PANEL));
